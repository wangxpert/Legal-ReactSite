...
const CAFormArticlesOfIncorporation2 = (props) => {
  return (
      ...
      <div className={styles.content}>
        <div>
          ...
          <div>
            ...
            <br/>
          <div>
            4.&emsp;The name of the corporation&quot;s agent for the service of process is:
            <br/>
            <br/>
...
export default CAFormArticlesOfIncorporation2;
