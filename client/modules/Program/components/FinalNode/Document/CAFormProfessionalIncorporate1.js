  ...
  return (
    <div className={ styles.container }>
      <div className={ styles.header }>
        <div className={ styles.head }>CA Form Articles of Professional Incorporation 1</div>
      ...
      <div className={ styles.content }>
        <ol>
          ...
          <li>
            The corporation is a professional corporation within the meaning of California Corporations Code section 13400 et seq. The purpose of the corporation is to engage in the profession of { info.company_profession } and any other lawful activities (other than the banking or trust company business) not prohibited to a corporation engaging in such profession by applicable laws and regulations of California.
          </li>
      ...
      <div className={ styles.footer }>
        ...
        <div className="col-xs-7" style={{ textAlign: 'right' }}>
          <span className={ styles.info }>
            <span className={ styles['info-content'] }>________________</span><br/>
